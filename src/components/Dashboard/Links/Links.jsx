...
const Links = () => {
  ...
  useEffect(() => {
    if (user !== null) {
      ...
      apiUser.getLinksClicked(user?.id).then(({ data }) => {
        setClickLinks({
    ...
    if (data.length > 0) {
      for (let i = 1; i <= graphMonth.length; i++) {
        for (let j = 0; j < data.length; j++) {
          if (
            graphMonth[i]?.toString() ===
            (data[j].tx_date.slice(-2) < 10
              ? data[j].tx_date.slice(-1)
              : data[j].tx_date.slice(-2))
          ) {
            graphMonth[i] = {
              name: i,
          ...
          <Row>
            <Col xxl={6}>
              <div className="links__info-chart-partners">
                <div className="chart-partners__menu">
                  <div className="menu__range">
                    <button
                      className={classNames({ active: activeMonthBtn })}
                      onClick={handleClickMonth}
                    >
                      {window.innerWidth < 690 ? "M" : t("links:month")}
                    </button>
                    <button
                      className={classNames({ active: activeYearBtn })}
                      onClick={handleClickYear}
                    >
                      {window.innerWidth < 690 ? "Y" : t("links:year")}
                    </button>
                  </div>
                  {!activeYearBtn && (
                    <select
                    ...
                    >
                      <option
                        value={
                          selectedYear === "2023" ? "2023-01-01" : "2022-01-01"
                        }
                      >
                        {t("links:jan")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-02-01" : "2022-02-01"
                        }
                      >
                        {t("links:feb")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-03-01" : "2022-03-01"
                        }
                      >
                        {t("links:mar")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-04-01" : "2022-04-01"
                        }
                      >
                        {t("links:apr")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-05-01" : "2022-05-01"
                        }
                      >
                        {t("links:may")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-06-01" : "2022-06-01"
                        }
                      >
                        {t("links:june")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-07-01" : "2022-07-01"
                        }
                      >
                        {t("links:july")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-08-01" : "2022-08-01"
                        }
                      >
                        {t("links:aug")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-09-01" : "2022-09-01"
                        }
                      >
                        {t("links:sep")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-10-01" : "2022-10-01"
                        }
                      >
                        {t("links:oct")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-11-01" : "2022-11-01"
                        }
                      >
                        {t("links:nov")}
                      </option>
                      <option
                        value={
                          selectedYear === "2023" ? "2023-12-01" : "2022-12-01"
                        }
                      >
                        {t("links:dec")}
                      </option>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setSelectedMonth(
                        `${e.target.value}${selectedMonth.slice(4)}`
                      );
                    }}
                    defaultValue={"2023"}
                  >
                ...
                {data.length === 0 ? (
                  <p className="no-data">{t("links:no-data")}</p>
                ) : (
                  <ResponsiveContainer>
                    <BarChart
              ...
              <div className="text" style={{ marginTop: 16 }}>
                <h3>{t("links:personal-links")}</h3>
                <p>{t("links:personal-links-text")}</p>
              </div>
            </Col>
            <Col xxl={6}>
              <div className="links__info-stats">
                <div className="links__info-stats-top">
                  <div>
                    <div>
                      {t("links:links-clicked")}
                      <OverlayTrigger
                        placement="top"
                        overlay={
                          <Tooltip>{t("links:links-clicked-tooltip")}</Tooltip>
                        }
                      >
                        <svg
                          width="18"
                    ...
                    <div>
                      <p>{clickLinks.totalClicks}</p>
                      <span>+ {clickLinks.lastDayClicks}</span>
                    </div>
                  </div>
                  <div>
                    <div>
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={
                          <Tooltip>{t("links:partners-tooltip")}</Tooltip>
                        }
                      >
                        <svg
                          width="18"
                  ...
                  <div>
                    <div>
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>{t("links:team-tooltip")}</Tooltip>}
                      >
                        <svg
                          width="18"
                          height="18"
                  ...
                  <div className="bot-info">
                    <div>
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={
                          <Tooltip> {t("links:profits-tooltip")}</Tooltip>
                        }
                      >
                        <svg
                          width="18"
                ...
                <div
                  className="main-info__user-link user-link-stats"
                  style={{ marginTop: 24 }}
                >
                  <div>
                    <div>
                      <div className="user-link__top">
                        {t("links:personal-link")}
                        <OverlayTrigger
                          placement="top"
                          overlay={
                            <Tooltip>
                              {t("links:personal-link-tooltip")} <br />
                              {t("links:personal-link-tooltip-2")}
                            </Tooltip>
                          }
                        >
                          <svg
