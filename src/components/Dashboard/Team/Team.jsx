...
const Team = () => {
  ...
  useEffect(() => {
    if (user !== null) {
      contract.methods["getPartnersById(uint256,uint256,uint256)"](
        user?.id,
        skip,
        limit
      )
        ...
        <>
          <Table responsive>
            <thead>
              <tr>
                <th>{t("team:date")}</th>
                <th>{t("team:address")}</th>
                <th>ID</th>
                <th>{t("team:profit")}</th>
                <th>{t("team:partners")}</th>
              </tr>
            </thead>
            <tbody>
              {partners?.length > 0 &&
                partners?.map((partner, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        <div className="partner-id">ID {partner.partnerId}</div>
                      </td>
                      <td>
                        ...
                        <div className="partners">
                          ...
                          >
                            ...
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M14.0878 8.25311C14.0878 9.96638 12.7142 11.3401 10.9997 11.3401C9.28578 11.3401 7.91152 9.96638 7.91152 8.25311C7.91152 6.53984 9.28578 5.16666 10.9997 5.16666C12.7142 5.16666 14.0878 6.53984 14.0878 8.25311ZM10.9997 16.8333C8.46939 16.8333 6.33301 16.4221 6.33301 14.8354C6.33301 13.2481 8.48281 12.8515 10.9997 12.8515C13.5305 12.8515 15.6663 13.2627 15.6663 14.8494C15.6663 16.4367 13.5165 16.8333 10.9997 16.8333Z"
                              fill="#BFBFC1"
                            />
                          </svg>
                          {partner.refCount}
                ...
                return (
                  <div className="transaction" key={index}>
                    ...
                    <div className="transaction__bottom">
                      <div className="name">In-Space</div>
                      <div className="amount">{partner.earned / 1e18}</div>
                    </div>
                  </div>
                );
              })}
          ...
          {total !== partners?.length && (
            <button onClick={handleLoadMore}>{t("team:load-more")}</button>
          )}
        </>
      )}
    </div>
