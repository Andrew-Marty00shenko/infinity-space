      ...
      <div className="all-transactions__info">
                    ...
                    {transaction.tx_type === "profit" ? (
                      <>
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            {t("transactions:in-level")} {transaction.level}{" "}
                            {transaction.level === 1 &&
                              transaction.tx_type === "payment" &&
                              t("transactions:registration")}{" "}
                          </p>
                        </div>
                      </>
                      ...
                      <>
                        ...
                        >
                          ...
                          />
                          <path
                            d="M13 27.8333C13 31.2646 14.5885 32 22 32C29.4115 32 31 31.2646 31 27.8333C31 24.4021 29.4115 23.6667 22 23.6667C14.5885 23.6667 13 24.4021 13 27.8333Z"
                            fill="#7B4CFF"
                          />
                          <path
                            d="M17.0909 17C17.0909 19.7614 19.2888 22 22 22C24.7112 22 26.9091 19.7614 26.9091 17C26.9091 14.2386 24.7112 12 22 12C19.2888 12 17.0909 14.2386 17.0909 17Z"
                            fill="#7B4CFF"
                          />
                        </svg>
                        <div>
        ...
        <div className="info-list-total">
          <div className="total-users">
            <p> {t("transactions:users-total")} </p>
            <div>
              {results?.totalUsers || 0}
              <span>{/* + {totals?.joinedAtLatestDay || 0} */}</span>
            </div>
          </div>
          <div className="total-reached">
            <p> {t("transactions:users-have-earned")}, BUSD</p>
            <div>
          ...
          <div className="total-info">
            <p>IN SPACE {t("transactions:contract-address")}</p>
            <p>
              0xB1Bc...0dbf
              <span>
                <CopyToClipboard
                  text={"0xB1Bc72552418418a2e0D098D00E6C72e674E0dbf"}
                  onCopy={() =>
            ...
            <div>
              {t("transactions:transactions-total")}
              <div>
                {total || 0}
                <span>{/* + {totals?.transactionsAtLatestDay || 0} */}</span>
              </div>
            </div>
          </div>
        </div>
