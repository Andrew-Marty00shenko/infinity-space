      ...
      <ul className="sidebar__menu">
        ...
        >
          ...
          >
            ...
            {t("sidebar:marketing-presentation")}
          </li>
        </Link>
       
        <Link
          to="/dashboard/play2earn-game"
          onClick={() => setShowSidebar(false)}
        >
          <li
            className={classNames({
              active: location.pathname === "/dashboard/play2earn-game",
            })}
          >
            <div className="gradient"></div>
            <svg
