...
import Image1 from "../../../../assets/images/dashboard/learning-tools/img1.png";
...
import "./LearningToolsItem.scss";

const LearningToolsItem = () => {
  return (
    <div className="learning-tools-item">
      <Breadcrumbs location={"Learning tool"} />

      <div className="learning-tools-item__top">
        <div className="background-block"></div>
        <div className="image">
          <img className="img-1" src={Image1} alt="" />
        </div>
        <div className="learning-tools-item__top-block">
      ...
      <div className="learning-tools-item__content">
