  ...
  return (
    <div className="level">
      <div className="level__info">
        <Link to="/dashboard/user/levels"> ID {user?.id} </Link> &#62;{" "}
        <span>
          {t("levels:level")} {params.id}
        </span>
      </div>
      ...
      <div className="level__header">
        ...
        <OverlayTrigger
          placement="top"
          overlay={<Tooltip>{t("levels:level-tooltip")}</Tooltip>}
        >
          <svg
            width="24"
            height="24"
            ...
            <div className="card-content__info">
              ...
              <div>
                ...
                >
                  ...
                  />
                  <path
                    d="M8.72656 23.9838L12.5583 20.1519L16.39 23.9838L12.5583 27.8158L8.72656 23.9838ZM14.4949 18.2167L23.9841 8.72656L27.8158 12.5585L18.326 22.0484L14.4949 18.2167ZM14.4541 29.7123L29.7127 14.4527L33.5444 18.2846L18.2856 33.544L14.4541 29.7123ZM20.1817 35.4403L35.4403 20.1806L39.272 24.0126L24.0131 39.272L20.1817 35.4403Z"
                    fill="#FFED4C"
                  />
                </svg>
              ...
              <div className="partners-block">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M22.8234 9.15192C22.8234 14.047 18.8986 17.972 14.0001 17.972C9.10323 17.972 5.17676 14.047 5.17676 9.15192C5.17676 4.25687 9.10323 0.333496 14.0001 0.333496C18.8986 0.333496 22.8234 4.25687 22.8234 9.15192ZM14.0003 33.6668C6.77095 33.6668 0.666992 32.4918 0.666992 27.9584C0.666992 23.4234 6.8093 22.29 14.0003 22.29C21.2314 22.29 27.3337 23.4651 27.3337 27.9984C27.3337 32.5335 21.1914 33.6668 14.0003 33.6668Z"
                    fill="white"
                  />
                </svg>
                <div>
                  <p>ID</p>
                  <span>{currentLevel?.firstThreeRefferrals[0] || 0}</span>
                </div>
              </div>
              <div className="partners-block">
                <svg
                ...
                <div>
                  <p>ID</p>
                  <span>{currentLevel?.firstThreeRefferrals[1] || 0}</span>
                </div>
              </div>
              <div className="partners-block">
                <svg
                ...
                <div>
                  <p>ID</p>
                  <span>{currentLevel?.firstThreeRefferrals[2] || 0}</span>
                </div>
              </div>
            </div>
              ...
              <div className="other-stats">
                <div>
                  ...
                  <div>
                    ...
                    >
                      <path
                        d="M4 24.5775C4 21.9079 5.9398 19.634 8.57605 19.2133L8.81351 19.1754C10.9245 18.8385 13.0755 18.8385 15.1865 19.1754L15.424 19.2133C18.0602 19.634 20 21.9079 20 24.5775C20 25.7314 19.0646 26.6668 17.9107 26.6668H6.08929C4.93541 26.6668 4 25.7314 4 24.5775Z"
                        stroke="white"
                        strokeWidth="2"
                      />
                      <path
                        d="M16.6667 10.0002C16.6667 12.5775 14.5773 14.6668 12 14.6668C9.42267 14.6668 7.33333 12.5775 7.33333 10.0002C7.33333 7.42283 9.42267 5.3335 12 5.3335C14.5773 5.3335 16.6667 7.42283 16.6667 10.0002Z"
                        stroke="white"
                        strokeWidth="2"
                      />
                      <path
                        d="M20 14.6668C22.5773 14.6668 24.6667 12.5775 24.6667 10.0002C24.6667 7.42283 22.5773 5.3335 20 5.3335M23.1865 26.6668H25.9107C27.0646 26.6668 28 25.7314 28 24.5775C28 21.9079 26.0602 19.634 23.424 19.2133V19.2133C23.2659 19.188 23.1058 19.1754 22.9457 19.1754C22.5194 19.1754 22.387 19.1754 21.6549 19.1754"
                        stroke="white"
                        strokeWidth="2"
                        strokeLinecap="round"
                      />
              ...
              <div className="other-revenue">
                <div>
                  ...
                  <div>
                    ...
                    >
                      <path
                        d="M0 12.9869L3.2615 9.72512L6.52301 12.9869L3.2615 16.2486L0 12.9869ZM4.90993 8.07794L12.9871 0L16.2486 3.26173L8.17098 11.3394L4.90993 8.07794ZM4.87526 17.8629L17.8632 4.87401L21.1247 8.13574L8.13653 21.1244L4.87526 17.8629ZM9.75051 22.7385L22.7385 9.7496L26 13.0113L13.0118 26L9.75051 22.7385Z"
                        fill="white"
                      />
                    </svg>
      ...
      <div className="level__pagination">
        <ReactPaginate
          ...
          nextLabel={t("levels:next")}
          onPageChange={handlePageClick}
          marginPagesDisplayed={1}
          pageRangeDisplayed={1}
          pageCount={12}
          previousLabel={t("levels:previous")}
