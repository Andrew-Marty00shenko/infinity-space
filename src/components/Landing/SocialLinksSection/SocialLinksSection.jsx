      ...
      <div className="social-links-section__block">
        ...
        <a href="https://twitter.com/InSpace_Web3" target="_blank">
          <div>
            ...
            >
              <path
                d="M21 3.00011L18.75 3.37511L20.25 1.50011L17.625 2.25011C14.25 -1.49989 9 2.62511 10.5 6.00011C4.5 6.00011 1.5 1.50011 1.5 1.50011C1.5 1.50011 -0.75 4.87511 3 7.50011L0.75 6.75011C0.75 9.00011 2.25 10.5001 4.875 11.2501H2.25C3.75 14.2501 6.375 14.2501 6.375 14.2501C6.375 14.2501 4.125 16.1251 0 16.1251C12.375 22.1251 19.875 10.8751 18.75 4.87511L21 3.00011Z"
                fill="white"
              />
            </svg>
            Twitter
