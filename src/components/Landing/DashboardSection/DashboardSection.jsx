  ...
  return (
    <section className="dashboard-section">
      <div className="dashboard-section__block">
        {isWebpSupported() ? (
          <img
            className="dashboard-laptop-desktop"
            height="500"
            src={DashboardLaptopWebp}
            alt="laptop"
          />
        ) : (
          <img
        ...
        {isWebpSupported() ? (
          <img
            className="dashboard-laptop-tablet"
            src={DashboardLaptopopTabletWebp}
            alt="laptop"
          />
        ) : (
          <img
            className="dashboard-laptop-tablet"
            src={DashboardLaptopopTablet}
            alt="laptop"
          />
        )}
        {isWebpSupported() ? (
          <img
            className="dashboard-laptop-mobile"
            src={DashboardLaptopopMobileWebp}
            alt="laptop"
            height="280"
          />
        ) : (
        ...
        >
          <path
            d="M0 98.4004L24.7122 73.6865L49.4243 98.4004L24.7122 123.114L0 98.4004ZM37.2022 61.2059L98.4021 0L123.114 24.7139L61.9109 85.9181L37.2022 61.2059ZM36.9394 135.346L135.348 36.93L160.061 61.6439L61.6499 160.058L36.9394 135.346ZM73.8789 172.288L172.288 73.872L197 98.5859L98.5893 197L73.8789 172.288Z"
            fill="url(#paint0_linear_8_593)"
            fillOpacity="0.2"
          />
          <defs>
            <linearGradient
              id="paint0_linear_8_593"
              x1="105.359"
              y1="21.2443"
              x2="105.359"
              y2="228.59"
      ...
      <div className="dashboard-section__block">
        <h2>
          {t("dashboardSection:title-1")} <br /> {t("dashboardSection:title-2")}
        </h2>
        <p>{t("dashboardSection:text")}</p>
        <div className="buttons-block">
          <Link to="/">
            <button onClick={handleClickConnectWallet} disabled={loading}>
              {loading ? "Loading..." : t("dashboardSection:connect-btn")}
            </button>
          </Link>
        </div>
        <svg
        ...
        >
          <path
            d="M0 98.4004L24.7122 73.6865L49.4243 98.4004L24.7122 123.114L0 98.4004ZM37.2022 61.2059L98.4021 0L123.114 24.7139L61.9109 85.9181L37.2022 61.2059ZM36.9394 135.346L135.348 36.93L160.061 61.6439L61.6499 160.058L36.9394 135.346ZM73.8789 172.288L172.288 73.872L197 98.5859L98.5893 197L73.8789 172.288Z"
            fill="url(#paint0_linear_8_592)"
            fillOpacity="0.2"
          />
          <defs>
            <linearGradient
              id="paint0_linear_8_592"
              x1="105.359"
              y1="21.2443"
              x2="105.359"
              y2="228.59"
